...
struct Previews_Test_Previews: PreviewProvider {
  static var previews: some View {
    EnvironmentVariationPreview(
      environmentValues: [ .colorScheme(.light), .colorScheme(.dark), .layoutDirection(.rightToLeft), .dynamicTypeSize(.xSmall), .dynamicTypeSize(.large), .dynamicTypeSize(.xxxLarge) ],
